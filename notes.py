...
# canny_image = cv2.Canny(gray_image, 100, 400)
...
#                                    np.array(list(region_of_interest_vertices), np.int32))

# lines = cv2.HoughLinesP(cropped_image, rho=6, theta=np.pi/60, threshold=90, lines=np.array([]), minLineLength=40, maxLineGap=10)
